...
[`@aws-sdk/client-arc-zonal-shift`](https://www.npmjs.com/package/@aws-sdk/client-arc-zonal-shift/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-arc-zonal-shift@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gI4ATcToGy4gmDnvthXWG21R/JntPcmbA0dmfb2HBXaOoNVpjwhYQTSv+vbzmKqs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-arc-zonal-shift": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-arc-zonal-shift@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-arc-zonal-shift@3.741.0/index.min.mjs": "sha384-gI4ATcToGy4gmDnvthXWG21R/JntPcmbA0dmfb2HBXaOoNVpjwhYQTSv+vbzmKqs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-arc-zonal-shift/blob/refs/tags/3.741.0/LICENSE
```
